...
public class Password_Change extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel11.setText("COS PAY-Password Change");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(pass1, javax.swing.GroupLayout.DEFAULT_SIZE, 157, Short.MAX_VALUE)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(pass)
                        .addComponent(uid, javax.swing.GroupLayout.DEFAULT_SIZE, 157, Short.MAX_VALUE)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            if(rs.next())
            {
                ...
                if (Pass!=Pass1)
                {
                String strSQL = "UPDATE CUSTOMER SET PASSWORD = '"+(Pass1)+"' WHERE USERNAME='"+(Uid)+"'";
                ...
                {
                 JOptionPane.showMessageDialog(this, "Old Password Cannot Be The New Password!");   
                }
            }
            else
            {
