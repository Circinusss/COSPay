...
public class Balance extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel11.setText("COS PAY-Balance");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(98, 98, 98)
                        .addComponent(amt, javax.swing.GroupLayout.PREFERRED_SIZE, 157, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       try
        {
            String  UD; String Pass;
            UD=uid.getText();
            Pass=pass.getText();
       Class.forName("com.mysql.jdbc.Driver");    
       Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/cospay","root","circinus");
       Statement stmt = con.createStatement();
       String query="SELECT * FROM CUSTOMER WHERE USERNAME='"+UD+"' AND PASSWORD='"+Pass+"';";
       PreparedStatement pst = con.prepareStatement(query);
       pst.setString(1,uid.getText());
       pst.setString(2,pass.getText());
                    

       String strSQL= "SELECT BALANCE FROM AMOUNT WHERE USERNAME ='"+(UD)+"';";
      ...
      //float rowsEffected = Float.parseFloat("pst.executeQuery(strSQL)");
      float rowsEffected = Float.parseFloat(""+pst.executeQuery(strSQL));
      //float result = Float.parseFloat(""+rowsEffected);
    //double balance=rowsEffected.getDouble("BALANCE");
      amt.setText(""+rowsEffected);
       }
         else      
        {
